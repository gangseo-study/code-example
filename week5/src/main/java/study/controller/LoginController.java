package study.controller.login;
...
import study.service.login.LoginService;
 ...
 * - @Controller의 어노테이션의 주 목적은 View를 반환하기 위해 사용한다. HandlerMapping을 통해 요청 URI에 맞는
 * - @Controller를 찾고, ViewResolver를 통해 어떠한 View를 내보낼지 결정한다.
 * - 뷰가 아닌 데이터를 반환하고 싶을 때는 @ResponseBody 어노테이션을 통해 JSON 데이터를 반환할 수 있다.
 * ----------------
